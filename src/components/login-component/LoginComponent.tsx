...
function LoginComponenet() {
  ...
  if (loading) {
    return <div className="login-component"><Spinner/></div>; 
  }
  ...
  return (
    <>
      <div className="login-component">
        ...
        <div className={`login-component-container ${isRightPanelActive ? 'right-panel-active' : ''}`} id="login-component-container">
          ...
          <div className="overlay-container">
            <div className="overlay">
              <div className="overlay-panel overlay-left">
                ...
                <button className="button ghost" id="signIn" onClick={() => setRightPanelActive(false)}>Sign In</button>
              </div>
              <div className="overlay-panel overlay-right">
                <h1>Sign Up</h1>
                <p>Create an account to start the journey with us.</p>
                <button className="button ghost" id="signUp" onClick={() => setRightPanelActive(true)}>Sign Up</button>
              </div>
            </div>
          </div>
        </div>
